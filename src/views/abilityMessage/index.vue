...
<template>
  <el-container class="el-contain-div">
      ...
      <publicSubTop :title="title">
        <template v-slot:right>
          <div v-if="pageType==2" style="text-align:center;width: 100%">
            <el-button :loading="loadingBTN" type="primary" @click="onSubmit('form')">保 存</el-button>
    ...
    <el-main v-if="pageType==2">
      <add ref="add" :details="itemData" :isEdit="isEdit" @onCloseLoading="onCloseLoading"
           v-on:closeDialog="closeDialog"></add>
    </el-main>
    <el-main v-if="pageType==3">
      <detail ref="detail" :itemData="itemData"></detail>
    </el-main>
  </el-container>
</template>
