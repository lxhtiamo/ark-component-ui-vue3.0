<template>
    <div :class="b()">
        <el-card :class="b('box')">
            <template #header  v-if="vaildData(tableOption.title,false) || vaildData(tableOption.dateBtn,config.dateBtn)">
                <div
                    :class="b('title')">
            ...
            <div class="avue-crud__tip" v-if="vaildData(tableOption.tip,config.tip) && tableOption.selection">
        <span class="avue-crud__tip-name">
          ...
          {{ config.tipEndTitle }}
                    ...
                    <template #default="scope">
                        ...
                        <template v-else-if="['button','text','icon'].includes(menuType)">
                            <el-button :type="menuText('primary')"
                                       ...
                                       v-if="vaildData(tableOption.cellBtn ,config.cellBtn)">{{ menuIcon(scope.row.$cellEdit ? config.cellSaveBtnTitle : config.cellEditBtnTitle) }}
                            </el-button>
                            <el-button :type="menuText('success')"
                                       ...
                                       v-if="vaildData(tableOption.viewBtn,config.viewBtn)">{{ menuIcon(config.viewBtnTitle) }}
                            </el-button>
                            <el-button :type="menuText('primary')"
                                       ...
                                       v-if="vaildData(tableOption.editBtn,config.editBtn)">{{ menuIcon(config.editBtnTitle) }}
                            </el-button>
                            <el-button :type="menuText('danger')"
                                       ...
                                       v-if="vaildData(tableOption.delBtn,config.delBtn)">{{ menuIcon(config.delBtnTitle) }}
                            </el-button>
                        </template>
                        <slot name="menu"
                              :row="scope.row"
            ...
            <!-- 分页 -->
            <div :class="b('pagination')" v-if="pageFlag" style="display: flex;align-items: center;justify-content: flex-end;">
                <el-pagination :current-page="defaultPage.currentPage"
